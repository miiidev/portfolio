    ...
    >
      <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mt-10 w-full max-w-2xl overflow-hidden rounded-xl border border-edge bg-surface"
        >
        ...
        >
          <div>
            ...
            <a
              href={`mailto:${personalInfo.socials.email}`}
              className="block break-all text-lg text-copy hover:opacity-80 transition-opacity duration-200"
            >
